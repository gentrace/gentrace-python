# gentrace.model.create_multiple_test_cases.CreateMultipleTestCases
...
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | Input for the test case. Must be a valid JSON object and not an array. | 
...
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | Expected outputs for the test case | 
