...
class IngestionApi(object):
    ...
    def pipeline_run_post(self, pipeline_run_request : PipelineRunRequest, **kwargs) -> PipelineRunResponse:  # noqa: E501
        ...
        >>> thread = api.pipeline_run_post(pipeline_run_request, async_req=True)
        >>> result = thread.get()

        :param pipeline_run_request: (required)
        :type pipeline_run_request: PipelineRunRequest
    ...
    def pipeline_run_post_with_http_info(self, pipeline_run_request : PipelineRunRequest, **kwargs):  # noqa: E501
        ...
        >>> thread = api.pipeline_run_post_with_http_info(pipeline_run_request, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(PipelineRunResponse, status_code(int), headers(HTTPHeaderDict))
        """
