    ...
    class MetaOapg:
        class properties:
            ...
            class stats(schemas.DictSchema):
                ...
                def get_item_oapg(
                    self, name: typing_extensions.Literal["pending"]
                ) -> typing.Union[MetaOapg.properties.pending, schemas.Unset]:
                    ...

                @typing.overload
                def get_item_oapg(
                    self, name: typing_extensions.Literal["failure"]
                ) -> typing.Union[MetaOapg.properties.failure, schemas.Unset]:
                    ...

                @typing.overload
                def get_item_oapg(
                    self, name: typing_extensions.Literal["done"]
                ) -> typing.Union[MetaOapg.properties.done, schemas.Unset]:
                    ...
