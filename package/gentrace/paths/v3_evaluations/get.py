        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['EvaluationV3']:
                        return EvaluationV3
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['EvaluationV3'], typing.List['EvaluationV3']],
                ...
                def __getitem__(self, i: int) -> 'EvaluationV3':
...
class V3EvaluationsGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def v3_evaluations_get(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def v3_evaluations_get(
        ...
        return self._v3_evaluations_get_oapg(
