    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class context(
                ...
                def __getitem__(self, name: typing.Union[typing_extensions.Literal["userId", "render", ], str]):
                    # dict_instance[name] accessor
                    return super().__getitem__(name)
                ...
                def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["userId", "render", ], str]):
                    return super().get_item_oapg(name)
