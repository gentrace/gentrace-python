...
class RunRequest(schemas.DictSchema):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class collectionMethod(schemas.EnumBase, schemas.StrSchema):
    ...
    @typing.overload
    def __getitem__(
        self, name: typing_extensions.Literal["collectionMethod"]
    ) -> MetaOapg.properties.collectionMethod: ...
    @typing.overload
    def __getitem__(
        self, name: typing_extensions.Literal["slug"]
    ) -> MetaOapg.properties.slug: ...
    @typing.overload
    def __getitem__(
    ...
    def get_item_oapg(
        self, name: typing_extensions.Literal["collectionMethod"]
    ) -> typing.Union[MetaOapg.properties.collectionMethod, schemas.Unset]: ...
    @typing.overload
    def get_item_oapg(
        self, name: typing_extensions.Literal["slug"]
    ) -> typing.Union[MetaOapg.properties.slug, schemas.Unset]: ...
    @typing.overload
    def get_item_oapg(
        self, name: typing_extensions.Literal["name"]
    ...
    def __new__(
        ...
        *_args: typing.Union[
        ...
        collectionMethod: typing.Union[
            MetaOapg.properties.collectionMethod, str, schemas.Unset
        ] = schemas.unset,
        slug: typing.Union[
            MetaOapg.properties.slug, str, schemas.Unset
        ] = schemas.unset,
        name: typing.Union[
