            ...
            class stepRuns(
                ...
                class MetaOapg:
                    ...
                    class items(
                        ...
                        def __getitem__(self, name: typing.Union[typing_extensions.Literal["stepRunId", "stepId", "providerName", "invocation", "order", "modelParams", "inputs", "outputs", "elapsedTime", "startTime", "endTime", "cost", "metadata", "error", ], str]):
                            # dict_instance[name] accessor
                            return super().__getitem__(name)
                        ...
                        def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["stepRunId", "stepId", "providerName", "invocation", "order", "modelParams", "inputs", "outputs", "elapsedTime", "startTime", "endTime", "cost", "metadata", "error", ], str]):
                            return super().get_item_oapg(name)
