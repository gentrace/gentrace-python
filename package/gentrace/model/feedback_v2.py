...
class FeedbackV2(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "pipelineRunId", "score", "recordedTime", "details", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "pipelineRunId", "score", "recordedTime", "details", ], str]):
