...
class ExpandedTestRun(
    ...
    class MetaOapg:
        ...
        class all_of_1(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["full", "steps", "case", "evaluations", "error", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["full", "steps", "case", "evaluations", "error", ], str]):
