...
class TestCaseV2(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "createdAt", "updatedAt", "archivedAt", "inputs", "name", "pipelineId", "expectedOutputs", "setId", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "createdAt", "updatedAt", "archivedAt", "inputs", "name", "pipelineId", "expectedOutputs", "setId", ], str]):
        return super().get_item_oapg(name)
