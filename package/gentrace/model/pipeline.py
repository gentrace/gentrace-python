...
class Pipeline(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "createdAt", "updatedAt", "labels", "slug", "organizationId", "goldenDatasetId", "archivedAt", "displayName", "branch", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "createdAt", "updatedAt", "labels", "slug", "organizationId", "goldenDatasetId", "archivedAt", "displayName", "branch", ], str]):
