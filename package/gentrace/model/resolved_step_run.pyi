...
class ResolvedStepRun(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "organizationId", "providerName", "invocation", "modelParams", "inputs", "outputs", "startTime", "endTime", "pipelineRunId", "error", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "organizationId", "providerName", "invocation", "modelParams", "inputs", "outputs", "startTime", "endTime", "pipelineRunId", "error", ], str]):
        return super().get_item_oapg(name)
