...
class TestCase(
    ...
    deletedAt: MetaOapg.properties.deletedAt
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "createdAt", "archivedAt", "deletedAt", "updatedAt", "inputs", "name", "pipelineId", "datasetId", "expectedOutputs", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["deletedAt"]) -> MetaOapg.properties.deletedAt: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "createdAt", "archivedAt", "deletedAt", "updatedAt", "inputs", "name", "pipelineId", "datasetId", "expectedOutputs", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        cls,
        *_args: typing.Union[dict, frozendict.frozendict, ],
        archivedAt: typing.Union[MetaOapg.properties.archivedAt, None, str, datetime, ],
        createdAt: typing.Union[MetaOapg.properties.createdAt, str, datetime, ],
        deletedAt: typing.Union[MetaOapg.properties.deletedAt, None, str, datetime, ],
