...
from gentrace.providers.init import GENTRACE_API_KEY, global_gentrace_config
...
def test_validity():
    ...
    if not api_key and not GENTRACE_API_KEY:
...
def configure_openai():
    ...
    if api_key:
        ...
        gentrace_config = global_gentrace_config
