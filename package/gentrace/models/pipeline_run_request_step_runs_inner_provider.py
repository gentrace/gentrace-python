...
class PipelineRunRequestStepRunsInnerProvider(BaseModel):
    ...
    model_params: Optional[Dict[str, PipelineRunRequestStepRunsInnerProviderModelParamsValue]] = Field(None, alias="modelParams")
    inputs: Optional[Dict[str, PipelineRunRequestStepRunsInnerProviderModelParamsValue]] = None
    ...
    def from_dict(cls, obj: dict) -> PipelineRunRequestStepRunsInnerProvider:
        ...
        _obj = PipelineRunRequestStepRunsInnerProvider.parse_obj({
            ...
            "model_params": dict((_k, Dict[str, PipelineRunRequestStepRunsInnerProviderModelParamsValue].from_dict(_v)) for _k, _v in obj.get("modelParams").items()),
            "inputs": dict((_k, Dict[str, PipelineRunRequestStepRunsInnerProviderModelParamsValue].from_dict(_v)) for _k, _v in obj.get("inputs").items()),
